...
import kiwi.orbit.compose.ui.generated.Res
import kiwi.orbit.compose.ui.generated.*
        ...
        trailingIcon = {
            Icon(
                ...
                contentDescription = when (showRawInput) {
                    true -> stringResource(Res.string.orbit_cd_text_field_hide_password)
                    false -> stringResource(Res.string.orbit_cd_text_field_show_password)
                },
            )
        },
