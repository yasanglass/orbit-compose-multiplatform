...
import glass.yasan.orbit.ui.foundation.BundleColors
import glass.yasan.orbit.ui.foundation.FeatureColors
...
private fun RowScope.Color(
    ...
    Column(
        ...
        Text(
            text = "#" + (color.toArgb() and 0xFFFFFF).toString(16).padStart(6, '0').uppercase(),
            style = OrbitTheme.typography.bodySmall,
            color = finalContentColor,
        )
    }
